...
def calculate_emissions(
    ...
    min_emission_factor_confidence: Annotated[float | None, Query(description="The confidence threshold for selecting emissions factors (0-1)")] = None
):
    ...
    enriched_products = pipeline_instance.calculate_emissions(url, start_date_parsed, end_date_parsed, min_emission_factor_confidence)
